package vip.xelapedia.discgolf.discs;

import lombok.AllArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.springframework.stereotype.Service;
import vip.xelapedia.discgolf.discs.dto.request.DiscUpsert;
import vip.xelapedia.discgolf.discs.dto.request.ManufacturerUpsert;
import vip.xelapedia.discgolf.discs.dto.request.MoldUpsert;
import vip.xelapedia.discgolf.discs.dto.request.PlasticUpsert;
import vip.xelapedia.discgolf.discs.dto.response.DiscResponse;
import vip.xelapedia.discgolf.discs.dto.response.ManufacturerResponse;
import vip.xelapedia.discgolf.discs.dto.response.MoldResponse;
import vip.xelapedia.discgolf.discs.dto.response.PlasticResponse;
...
public class DiscsModuleService {
    ...
    public DiscResponse upsertDisc(final DiscUpsert discUpsert) {
        ...
        final Disc disc = discService.persistDisc(discUpsert.toEntity());
        log.debug("<< DiscsModuleService.upsertDisc key: {}", discUpsert.key());
